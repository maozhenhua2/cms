...
export class Keepalive implements RouteReuseStrategy {
...
//     let isReUsed = future.routeConfig===curr.routeConfig && JSON.stringify(future.params)==JSON.stringify(curr.params);
...
//     }
//     return route['_routerState'].url.replace(/\//g, '_') + '_' + componentShortName;
//   }
